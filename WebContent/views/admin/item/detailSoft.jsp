...
<div style="margin-left: 20px; margin-bottom: 20px;margin-right: 20px;">
	...
	<tr style="line-height:40px;">
		...
		<td colspan="3">
		<input type="text" size="50px" id="itemID" name="itemID" value="${item.itemID}" readOnly="true" style="background: #F5F5F5;"/></td>
		<td></td>
	</tr>
	<tr style="line-height:40px;">
	...
	<tr style="line-height:40px;">
		...
		<td colspan="3">
		<input type="text" size="50px" name="name" id="proNameId" value="${item.name}" readOnly="true" style="background: #F5F5F5;"/>
	</td>
	<td></td>
	</tr>
	<tr style="line-height:40px;">
		...
		<td align="right">资费类型：</td>
			<c:choose>
				<c:when test="${product.isInSale=='T'}">
					<td colspan="2"><input type="radio" name="isInSale" class="inSaleClass" value="T" checked="checked"/>内计费</td>
					<td><input type="text" name="inSaleID" value="${product.inSaleID}" id="inSaleCodeId" disabled="disabled" /></td>
				</c:when>
				<c:otherwise>
					<td colspan="3"><input type="radio" checked="checked" name="isInSale" class="inSaleClass" value="F"/>免费</td>
				</c:otherwise>
			</c:choose>
		<td></td>
	</tr>
	...
	<tr style="line-height:40px;">
		...
		<td>
			<select name="isLineUpdate" disabled="disabled">
